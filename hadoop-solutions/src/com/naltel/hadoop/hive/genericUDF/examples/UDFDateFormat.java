...
@Description(name = "date_format", value = "_FUNC_(dateText,pattern) - Return time string with given pattern. ", extended = "Convert time string with 'yyyy-MM-dd HH:mm:ss' pattern to time string with given pattern.\n"
...
@HivePdkUnitTests(setup = "", cleanup = "", cases = {
		@HivePdkUnitTest(query = "SELECT nexr_date_format('2011-05-11 12:05:11', 'yyyyMMdd') FROM onerow;", result = "20110511"),
		@HivePdkUnitTest(query = "SELECT nexr_date_format('2011-07-21 09:21:00', 'yyyy-MM-dd') FROM onerow;", result = "2011-07-21") })
